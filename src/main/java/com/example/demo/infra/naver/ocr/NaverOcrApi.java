package com.example.demo.infra.naver.ocr;
...
public class NaverOcrApi {
    ...
    public static List<String> callApi(String type, String filePath, String naver_secretKey, String ext) {
        String apiURL = "https://nfy5xgs42c.apigw.ntruss.com/custom/v1/24381/da0961941073df4827c469a803452953cd2cf25e39d8766d18e2716cc845f9e5/general";	//자신이 생성한 APIGW URL
...
//            Map<String, Object> as = m.get(i);
//            if(as.get("inferText").equals("운송장번호")) {
//            	as = m.get(i+1);
